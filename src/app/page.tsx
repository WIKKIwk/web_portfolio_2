  ...
  return (
    <main className="relative min-h-screen bg-black text-white selection:bg-white/30 flex flex-col items-center">
      ...
      <div className="relative w-full">
        ...
        <div className="absolute left-[1%] md:left-[3%] lg:left-[4%] top-[80px] md:top-[100px] lg:top-[120px] bottom-[140px] md:bottom-[180px] lg:bottom-[200px] w-[120px] md:w-[180px] lg:w-[220px] opacity-20 pointer-events-none z-[5] hidden md:block">
          <Image
